...
if (topic === "arrays") {
 ...
 if (topic === "procedures") {
  ...
  titleEl.textContent = "Maintainable Programs Practice";
  introEl.textContent = "Practise exam-style questions. Write your answer on paper or in the box below, then click 'Show answer' to compare with the model answer.";
  return;
}
...
difficultyWrap.style.display =
  topic === "standardalgorithms" || topic === "refining" || topic === "stringhandling" || topic === "operations" || topic === "sequence" || topic === "selection" || topic === "iteration" || topic === "libraryroutines" || topic === "arrays" || topic === "procedures" || topic === "maintainableprograms" || topic === "filehandling" || topic === "databasetheory" || topic === "sql" || topic === "booleanlogic" ? "none" : "block";

}

if (modeWrap) {
modeWrap.style.display =
   topic === "refining" || topic === "stringhandling" || topic === "operations" || topic === "sequence" || topic === "selection" || topic === "iteration" || topic === "libraryroutines" || topic === "arrays" || topic === "procedures" || topic === "maintainableprograms" || topic === "filehandling" || topic === "databasetheory" || topic === "sql" || topic === "booleanlogic" ? "none" : "block";
}
...
if ([...modeEl.options].some(option => option.value === currentMode)) {
